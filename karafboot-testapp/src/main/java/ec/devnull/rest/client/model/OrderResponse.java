...
@ApiModel(value = "OrderResponse", description = "Detalles del procesamiento de una Orden")
public class OrderResponse {

    @ApiModelProperty(notes = "C\u00F3digo de Respuesta", required = true)
    private Integer returnCode;
    @ApiModelProperty(notes = "Descripci\u00F3n del  C\u00F3digo de Respuesta", required = true)
