...
public class JavassistTransformer {
    ...
    private Map<String, Map<String, Object>> getClasses() throws NotFoundException {
        ...
        resourcePatch.put(BODY_REPLACEMENT, "{  ec.devnull.karafboot.BundleURL bundleURL=new ec.devnull.karafboot.BundleURL(); return bundleURL.findResources($1,$2);  }");
        ...
        hibernatePatch.put(BODY_REPLACEMENT, "{         final String protocol = $1.getProtocol();\n" +
                ...
                "            return new ec.devnull.karafboot.JarInputStreamBasedArchiveDescriptor( this, $1, $2 );\n" +
                "        } }");
